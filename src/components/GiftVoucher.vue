<template>
    <aside>
        <div class="text-center w-full">
            ...
            To purchase a voucher simply select either 
            <a href="https://app.acuityscheduling.com/catalog.php?owner=13402788&action=addCart&id=1608112&clear=1">60 minute voucher - £60</a> or <a href="https://app.acuityscheduling.com/catalog.php?owner=13402788&action=addCart&clear=1&id=1608117">90 minute voucher - £85</a>.
            <p>Payment is by card or Paypal and you'll receive an email voucher which gives you an option to print and forward the voucher by email. In addition, please notify me if you'd like me to provide a traditional paper voucher. This can be posted to you or your recipient, it will have the same code on as the one you receive by email.</p>
